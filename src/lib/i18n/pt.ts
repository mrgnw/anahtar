...
const pt: Partial<AuthMessages> = {
	...
	passkeyTitle: 'Adicionar uma passkey?',
	passkeySubtitle: 'para um login mais rapido, facil e seguro',
	passkeyAdd: 'Adicionar passkey agora',
