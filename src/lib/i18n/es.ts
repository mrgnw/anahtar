...
const es: Partial<AuthMessages> = {
	...
	passkeyTitle: '¿Añadir un passkey?',
	passkeySubtitle: 'para iniciar sesion mas rapido, facil y seguro',
	passkeyAdd: 'Agregar passkey ahora',
